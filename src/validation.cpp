...
#if defined(NDEBUG)
# error "Wurzelpfrumpft cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Wurzelpfrumpft Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("wurzelpfrumpft-scriptch");
