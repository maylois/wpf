...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s wurzelpfrumpft-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  wurzelpfrumpft-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Wurzelpfrumpft transaction") + "\n" +
              "  wurzelpfrumpft-tx [options] -create [commands]   " + _("Create hex-encoded Wurzelpfrumpft transaction") + "\n" +
              "\n";
