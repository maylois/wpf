...
void Shutdown()
{
    ...
    RenameThread("wurzelpfrumpft-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://wurzelpfrumpft.de>";
    const std::string URL_WEBSITE = "<https://wurzelpfrumpft.de>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("wurzelpfrumpft-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Wurzelpfrumpft version %s\n", FormatFullVersion());
}
